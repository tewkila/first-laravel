    ...
    <div class="col-12">
        <div class="card card-primary">
            <div class="card-header" style="background-color: #fff">
                <h4 class="card-title" style="color:#000">Photos</h4>
                <div class="card-tools">
                    <div class="input-group input-group-sm" style="width: 150px;">
                        <a href="{{route('gallery.create')}}"><button type="button" class="btn btn-light " title="Add image"> <i style="color: #000; text-decoration: none;" class="fas fa-image"></i></button></a>
                        <a href="{{route('gallery.create.multiple')}}"><button type="button" class="btn btn-light " title="Add multiple images"> <i style="color: #000; text-decoration: none;" class="fas fa-images"></i></button></a>
                    </div>
                </div>
            </div>
            <div class="card-body">
